...
"""
    The communication with the gui works as follows:

    - emulator acts as the server
    - The gui connects to the server as a client
    - The client and server constantly send messages back and X times every
      second.
"""
