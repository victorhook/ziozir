...
class GlyphHandler(tk.Frame):
    ...
    def __init__(self, master, width, height, filepath: str = GLYPH_FILEPATH):
        ...
        self.add_btn = tk.Button(self.btn_container, text='New glyph', command=self._add)
        self.del_btn = tk.Button(self.btn_container, text='Delete glyph', command=self._del)
